...
class StylesApi {
  ...
  Future<Response<BuiltMap<String, JsonObject>>> stylesDarkJsonGet({
    required String key,
    bool? mobile = false,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'mobile':
          encodeQueryParameter(_serializers, mobile, const FullType(bool)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, JsonObject>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> stylesLightJsonGet({
    required String key,
    bool? mobile = false,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
